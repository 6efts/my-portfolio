  ...
  return (
    <>
      ...
      <div className="flex h-[65vh] bg-[#3e484a] ">
        ...
        <div className="flex items-end w-1/4 pl-8 text-2xl font-['Lato'] text-[#C4CFD2]">GO TO :<a className="ml-2 hover:text-[#D67835] " href=" https://github.com/6efts/project-1 " target="_blank">  GITHUB LINK</a></div>
      </div>
